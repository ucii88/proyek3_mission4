                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><h6 class="dropdown-header">Role: Admin</h6></li>
            ...
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 opacity-75">
                        Anda masuk sebagai Administrator. Total mahasiswa: <?= esc($total_students) ?>
                    </p>
                </div>
                    ...
                    <div class="col-md-6 mb-3">
                        <div class="card feature-card h-100">
                            <div class="card-body text-center">
                                ...
                                <a href="<?= base_url('/students') ?>" class="btn btn-primary">Buka</a>
                            </div>
                        </div>
                    </div>
                </div>
