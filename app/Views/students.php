...
<body>
    ...
    <script>
        // 1. Scope, Array, Object
        let students = [];  // Array of objects untuk menyimpan data mahasiswa
        let selectedStudents = []; 

        // 2. DOM Selector & Manipulation
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            console.log('Student management page loaded successfully at ' + new Date('2025-09-23T12:47:00+07:00').toLocaleString('id-ID', { timeZone: 'Asia/Jakarta' }));
        });
